...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
int Embedded_Fehlberg_7_8(double (*f)(double, double), double y[], double x, double h, double xmax, double* h_next, double tolerance) {
...
static double Runge_Kutta(double (*f)(double, double), double* y, double x0, double h) {
    ...
    k9 = (*f)(x0 + a9 * h, *y + h * (b91 * k1 + b94 * k4 + b95 * k5 + b96 * k6 + b97 * k7 + b98 * k8));
    k10 = (*f)(x0 + a10 * h, *y + h * (b10_1 * k1 + b10_4 * k4 + b10_5 * k5 + b10_6 * k6 + b10_7 * k7 + b10_8 * k8 + b10_9 * k9));
    k11 = (*f)(x0 + h, *y + h * (b11_1 * k1 + b11_4 * k4 + b11_5 * k5 + b11_6 * k6 + b11_7 * k7 + b11_8 * k8 + b11_9 * k9 + b11_10 * k10));
    k12 = (*f)(x0, *y + h * (b12_1 * k1 + b12_6 * k6 + b12_7 * k7 + b12_8 * k8 + b12_9 * k9 + b12_10 * k10));
    k13 = (*f)(x0 + h, *y + h * (b13_1 * k1 + b13_4 * k4 + b13_5 * k5 + b13_6 * k6+ b13_7 * k7 + b13_8 * k8 + b13_9 * k9 + b13_10 * k10 + k12));
    *(y + 1) = *y + h * (c_1_11 * (k1 + k11) + c6 * k6 + c_7_8 * (k7 + k8) + c_9_10 * (k9 + k10));
